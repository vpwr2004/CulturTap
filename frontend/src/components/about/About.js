    ...
    return (
        <div className='ml-[150px]'>
            ...
            <div className='mt-[76px]'>
                ...
                <div className='flex mt-[44px] gap-[25px]'>
                        ...
                        services.map((service) => {
                            return (
                                <div key={service.id} className='w-[325px] h-[505px] rounded-3xl shadow-md'>
                                    ...
                                    <p onClick={openModal} className='w-[max-content] mx-auto justify-center cursor-pointer mt-[31px] text-[16px] text-[#fbbc00] border-b-2 border-[#fbbc00] pb-1'>Know more</p>
